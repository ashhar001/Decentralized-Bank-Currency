...
module.exports = async function(deployer) {
	...
	const token = await Token.deployed();//token has the Token address
	
	//pass token address for dBank contract(for future minting)
	await deployer.deploy(dBank, token.address);//dbank is the .sol file location and token address
